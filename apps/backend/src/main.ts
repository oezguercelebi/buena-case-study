...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription(
      'A comprehensive API for efficient property onboarding and management, handling both WEG (condominium) and MV (rental) properties with support for bulk data entry and AI-powered document extraction.',
    )
    .setVersion('1.0')
    ...
    .setContact(
      ...
      'https://buena.example.com',
      'support@buena.example.com',
    )
