...
export class PropertyController {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a list of all properties in the system with their current status and completion information.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves comprehensive statistics about all properties including counts by type, status, and completion metrics.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a specific property by its unique identifier including all buildings and units.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new property with complete building and unit information. Validates business rules for property type.',
  })
  @ApiBody({
  ...
  @ApiResponse({
    status: 400,
    description:
      'Validation failed - check request body format and business rules',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Updates an existing property with new data. Partial updates are supported.',
  })
  @ApiParam({
    name: 'id',
    description: 'Unique property identifier',
  ...
  @ApiOperation({
    ...
    description:
      'Saves partial property data automatically during the onboarding process. Supports incremental updates without full validation.',
  })
  @ApiParam({
    name: 'id',
    description: 'Unique property identifier',
  ...
  @ApiOperation({
    ...
    description:
      'Updates data for a specific step in the property onboarding process. Step 1: General Info, Step 2: Building Data, Step 3: Units Data.',
  })
  @ApiParam({
    name: 'id',
    description: 'Unique property identifier',
  ...
  @ApiOperation({
    ...
    description:
      'Permanently removes a property and all associated data from the system.',
  })
  @ApiParam({
    name: 'id',
    description: 'Unique property identifier',
